...
function Jobapplicants() {
  return (
    ...
    <MainHeading heading={"Job Applicants"} path1={"Candidate"} path2={"Job Applicants"}/>
              ...
              <div class="card">
                <div class="card-body border-bottom">
                  <div class="d-flex align-items-center">
                    <h5 class="mb-0 card-title flex-grow-1"><span style={{color:'#556ee6'}}>109</span> Applications</h5>
