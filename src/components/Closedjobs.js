...
import Closedjobtable from './Closedjobtable';
...
function Closedjobs() {
  return (
    ...
    <>
      ...
      <MainHeading heading={"Closed Jobs"} path1={"Jobs"} path2={"Closed Jobs"}/>
                ...
                <div class="card">
                  <div class="card-body border-bottom">
                    <div class="d-flex align-items-center">
                      <h5 class="mb-0 card-title flex-grow-1">Closed Jobs Lists</h5>
